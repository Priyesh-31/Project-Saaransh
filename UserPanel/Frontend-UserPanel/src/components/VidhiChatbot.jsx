...
export const VidhiChatbot = () => {
  ...
  const generateResponse = (query) => {
    ...
    if (q.includes('comment') || q.includes('feedback') || q.includes('submit')) {
      return 'Great! You can submit your comments directly on the document details page. Look for the "Submit Comment" button or use the comment section to share your thoughts and feedback on this consultation.';
    }
