      ...
      <main className="container mx-auto px-4 py-5">
        ...
        <section className="mt-8 bg-white rounded-xl border border-gray-200 shadow-sm p-6">
          ...
          <p className="text-gray-700 mb-4">
            Follow these simple steps to share your opinion on draft policies and bills. SAARANSH turns public feedback into policy intelligence using AI.
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
              <h3 className="font-semibold text-[#092044] mb-2">1. Explore</h3>
              <p className="text-sm text-gray-600">Read the draft bill or amendment document and understand the key issue.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
              <h3 className="font-semibold text-[#092044] mb-2">2. Select</h3>
              <p className="text-sm text-gray-600">Choose the section or clause you want to comment on.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
              <h3 className="font-semibold text-[#092044] mb-2">3. Comment</h3>
              <p className="text-sm text-gray-600">Write your opinion, suggestion, or concern clearly in the comment box.</p>
            </div>
            <div className="rounded-lg border border-gray-200 p-4 bg-gray-50">
              <h3 className="font-semibold text-[#092044] mb-2">4. Submit</h3>
              <p className="text-sm text-gray-600">Save drafts or submit feedback securely.Your input is recorded for review.</p>
            </div>
          </div>

          <h3 className="text-lg font-semibold text-[#092044] mt-6">Key SAARANSH features</h3>
