              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-medium text-gray-900">COMP_AMEND_2025</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Type of Documents</label>
                    <p className="text-lg font-medium text-gray-900">Amendment</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <p className="text-lg font-medium text-gray-900">27 December 2025</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <label className="block text-sm font-semibold text-gray-700 mb-2">Comments due date</label>
                    <p className="text-lg font-medium text-gray-900">30 August 2025</p>
                  </div>
                </div>
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="prose prose-sm max-w-none">
                      <section>
                        <p className="mb-4">
                          The Companies Amendment Bill, 2025 is a comprehensive
                          legislative proposal introduced with the objective of
                          streamlining corporate regulations in India and
                          promoting greater transparency, accountability, and
                          ease of doing business. The bill seeks to amend
                          various sections of the Companies Act, 2013 to remove
                          outdated requirements, rationalize compliance
                          frameworks, expand regulatory oversight where
                          required, and encourage modern professional firm
                          structures that support the evolving needs of Indian
                          businesses.
                        </p>

                        <h3>Key Reform Areas</h3>
                        <p>
                          At its core, the bill proposes four major categories
                          of reforms: decriminalisation of minor offences and
                          rationalisation of penalties; introduction and
                          recognition of Multi-Disciplinary Firms (MDFs);
                          expansion of the powers and jurisdiction of the
                          National Financial Reporting Authority (NFRA); and
                          enhancements in compliance systems, digital
                          reporting, and shareholder engagement mechanisms.
                        </p>

                        <h4>1. Decriminalisation and Rationalisation of Minor Offences</h4>
                        <p>
                          The bill distinguishes serious corporate violations
                          from minor, technical, or procedural lapses and
                          proposes removing criminal penalties for offences
                          without malafide intent or stakeholder harm. Examples
                          include delays in routine filings, clerical errors in
                          statutory registers, and non-material discrepancies in
                          filings. Such cases will attract monetary penalties or
                          adjudication by Registrars of Companies (ROCs) with a
                          graded penalty system for repeat non-compliance.
                        </p>

                        <h4>2. Multi-Disciplinary Firms (MDFs)</h4>
                        <p>
                          The bill recognises and regulates Multi-Disciplinary
                          Firms where professionals from chartered accountancy,
                          company secretaryship, law, actuarial science and
                          other notified professions can collaborate to offer
                          integrated services. It outlines preliminary
                          eligibility, registration requirements and directs the
                          MCA to frame detailed rules covering composition,
                          conflict-of-interest safeguards, accountability and
                          quality control.
                        </p>

                        <h4>3. Expansion of NFRA Powers</h4>
                        <p>
                          NFRA&apos;s authority is significantly expanded to
                          improve audit oversight for listed and large
                          unlisted public companies. The bill provides NFRA
                          with powers to mandate remedial measures, conduct
                          regular inspections, enforce internal quality reviews,
                          and impose penalties including suspension of auditors
                          where necessary.
                        </p>

                        <h4>4. Digital Transformation &amp; Reporting</h4>
                        <p>
                          The bill directs the MCA to establish a unified
                          digital compliance portal that consolidates filings,
                          approvals and disclosures into a single interface,
                          enabling real-time tracking, AI-assisted validation
                          and automated reminders. It also introduces revised
                          reporting formats to improve disclosures, board
                          responsibility reporting, related-party transaction
                          summaries, and voluntary sustainability/ESG
                          reporting for large companies.
                        </p>

                        <h4>5. Strengthening Governance &amp; Accountability</h4>
                        <p>
                          Amendments include mandatory beneficial ownership
                          disclosures, enhanced oversight of independent
                          directors, stricter evaluation norms for board
                          committees, improved whistleblower protections, and
                          requirements for digital audit trails in accounting
                          systems.
                        </p>

                        <h4>6. Clarifications and Technical Amendments</h4>
                        <p>
                          The bill clarifies timelines for exceptional AGM
                          scenarios, refines definitions of small/associate/
                          subsidiary companies, explains CSR carry-forward
                          rules, and simplifies rules for conversion between
                          company forms.
                        </p>

                        <h4>7. Stakeholder Reactions</h4>
                        <p>
                          Stakeholders have reacted positively to
                          decriminalisation and digitalisation; audit firms and
                          professional bodies seek clarity on NFRA scope and
                          MDF governance. Startups and MSMEs welcome reduced
                          compliance burdens while some practitioners have
                          suggested phased implementation for complex changes.
                        </p>

                        <h4>8. Expected Impact</h4>
                        <p>
                          The bill should improve ease of doing business,
                          strengthen investor confidence, reduce litigation and
                          compliance costs, modernise corporate advisory via
                          MDFs, increase governance standards, and accelerate
                          digital transformation of regulatory processes.
                        </p>

                        <p className="mt-4">
                          <strong>Report posted on:</strong> 27 December 2025 —
                          <strong>Comments due:</strong> 30 August 2025.
                        </p>
                      </section>
                      <p className="mb-4">
