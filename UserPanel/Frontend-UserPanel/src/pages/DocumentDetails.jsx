      ...
      <main className="container mx-auto px-4 py-6">
        ...
        <div className="bg-white p-5 rounded-xl shadow-sm border mb-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-sm">
            <li><strong>Browse documents:</strong> Open the consultation topic and read the public notice.</li>
            <li><strong>Select a section:</strong> Pick the chapter or clause on which you want to comment.</li>
            <li><strong>Write feedback:</strong> Add your ideas, suggestions and concerns in the comment box.</li>
            <li><strong>Submit securely:</strong> Save draft or submit; your response is captured for policy analysis.</li>
            <li><strong>Track impact:</strong> See how your feedback contributes to better policy decisions.</li>
          </ol>

          <h4 className="text-md font-semibold mt-4">SAARANSH Features</h4>
          <ul className="list-disc list-inside space-y-1 text-sm">
            <li>AI sentiment insights for decision-makers</li>
            <li>Multi-ministry public consultation support</li>
            <li>Multilingual summary and audio playback</li>
            <li>Secure OTP-verified user submissions</li>
            <li>Comment history and draft saving</li>
          </ul>
        </div>
