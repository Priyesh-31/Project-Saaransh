          ...
          <TabsContent value="document-details" className="mt-6">
            <div className="mb-8 pb-6 border-b-2 border-gray-200">
              ...
              <p className="text-gray-600">
                Digital Competition Bill, 2025 - Review the document, read the summary, and submit your valuable feedback
              </p>
              <div className="flex items-center gap-4 mt-4 text-sm text-gray-500">
                <span>Posted: 26 March 2026</span>
                <span>Due: 15 April 2026</span>
              </div>
            </div>
